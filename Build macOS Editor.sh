...
scons p=macos arch=x86_64 target=editor profile=custom.py
scons p=macos arch=arm64 target=editor profile=custom.py
...
bin/godot.macos.editor.universal.mono --headless --generate-mono-glue modules/mono/glue --no-deprecated
